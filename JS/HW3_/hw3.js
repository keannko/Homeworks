...
// Деструктуризация нужна для манипуляций с объектами и массивами, позволяет извлекать данные и присваивать к переменным
...
const newEmployee = { ...employee, age: 33, salary: 1000 };
